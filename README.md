...
- The reward model training only supports datases with two response per prompt. We will add support for training with datasets that have more than 2 responses per prompt in future releases.
