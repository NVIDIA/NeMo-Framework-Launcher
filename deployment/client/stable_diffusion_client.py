...
def main():
    ...
    triton_input_grpc = [triton_grpc.InferInput('prompt', (1,), tritonclient.utils.np_to_triton_dtype(np.object_))]
    ...
    request_grpc = grpc_client.infer(
        'stable_diffusion', model_version='1', inputs=triton_input_grpc, outputs=[triton_output_grpc]
    )
