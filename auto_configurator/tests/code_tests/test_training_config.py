...
class TestCalculateTpPpMbsGrid:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (40.0, 48, 2048, "gpt3", {"tensor_parallel_sizes": "auto", "pipeline_parallel_sizes": "auto", "micro_batch_sizes": "auto", "gpu_memory_gb": 80, "min_model_parallel_size": "auto", "max_model_parallel_size": "auto"}, {"tp": [2,4,8], "pp": [1,2,3,4], "mbs": [1,2,4], "min_par": 8, "max_par": 32}),
