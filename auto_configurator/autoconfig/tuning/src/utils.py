...
def generate_finetuning_overrides_str(file_name: str, results_dir: str, cfg: omegaconf.dictconfig.DictConfig) -> str:
    """
    ...
    mounts_str = (
        f"{ft_configurator_path}:{ft_configurator_path},{results_dir}:{results_dir},{model_path}:{model_path}"
    )
...
def modify_cfg(base_cfg: omegaconf.dictconfig.DictConfig, candidate_id: str,
               **kwargs) -> omegaconf.dictconfig.DictConfig:
    """
